                        ...
                        <div key={fIdx} className="space-y-12">
                            ...
                            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-4">
                                    <div className="text-center pb-2 border-b border-gray-900 mb-4">
                                        ...
                                        <div className="text-[16pt] font-black text-green-600 mt-0.5">${flight.pots.front.toFixed(2)}</div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="text-center pb-2 border-b border-gray-900 mb-4">
                                        ...
                                        <div className="text-[16pt] font-black text-green-600 mt-0.5">${flight.pots.back.toFixed(2)}</div>
                                    </div>
                                    <div className="space-y-3">
                            ...
                            <div className="space-y-6">
                                <div className="text-center pb-2 border-b border-gray-900 max-w-sm mx-auto mb-6">
                                    ...
                                    <div className="text-[16pt] font-black text-green-600 mt-1">${flight.pots.total.toFixed(2)}</div>
                                </div>
                            ...
                            {Array.from(winningsMap.entries()).map(([name, amount]) => (
                                <div key={name} className="bg-[#f4fbf7] border border-green-100 rounded-lg p-3 flex justify-between items-center">
                                    <div className="flex flex-col overflow-hidden">
                                        ...
                                        <span className="text-[11pt] text-gray-600 truncate">{name.split(' ').slice(1).join(' ')}</span>
                                    </div>
