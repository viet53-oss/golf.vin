        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-[#f8fafc]">
                    <h2 className="text-[18pt] font-black text-gray-800 tracking-tight">Manage Pool Participants</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <div className="flex gap-4 mb-6">
                        <button
                            ...
                            className="text-[12pt] font-bold text-green-600 hover:text-green-700 transition-colors"
                        >
                            Select All
                        </button>
                        <button
                            onClick={() => setSelectedIds([])}
                            className="text-[12pt] font-bold text-red-600 hover:text-red-700 transition-colors"
                        >
                            Uncheck All
                        </button>
                    </div>
                ...
                <div className="px-6 py-5 bg-[#f8fafc] border-t border-gray-100 flex justify-end gap-3">
                    <button
                        onClick={onClose}
                        className="px-6 py-2.5 rounded-xl text-[12pt] font-bold text-gray-600 hover:bg-gray-200 transition-colors"
                        disabled={isSaving}
                    >
                        Cancel
                    </button>
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="bg-[#04d361] hover:bg-[#04b754] text-white px-8 py-2.5 rounded-xl text-[14pt] font-bold shadow-lg transition-all active:scale-95 flex items-center gap-2"
                    >
                        {isSaving ? (
                            <>
