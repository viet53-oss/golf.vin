...
export function PoolDateSelector({
    ...
    return (
        <select
            className="flex-1 mx-1 bg-white border border-gray-300 rounded-lg px-2 sm:px-4 py-2 sm:py-2.5 text-[12pt] sm:text-[14pt] font-bold text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500 appearance-none min-w-0"
