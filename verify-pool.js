...
async function verifyPool() {
    try {
        ...
        const frontNet = ray.front_nine - frontHcp;
        const backNet = ray.back_nine - backHcp;
        const totalNet = ray.gross_score - courseHcp;
        ...
        const allScores = round.players.map(rp => {
            ...
            return {
                name: rp.player.name,
                frontGross: rp.front_nine,
                frontHcp: fHcp,
                frontNet: rp.front_nine - fHcp
            };
