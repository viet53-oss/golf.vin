    ...
    return (
        <>
            <button
                ...
                className="w-full px-4 py-2 bg-black text-white rounded-full text-[15pt] font-bold hover:bg-gray-800 transition-colors flex items-center justify-center gap-2"
            >
