    ...
    return (
        <div className="space-y-3">
            <button
                onClick={handleFix}
                disabled={isPending}
                className="w-full bg-orange-600 hover:bg-orange-700 text-white px-1 py-3 rounded-full font-bold text-[14pt] shadow-lg hover:shadow-xl transition-all disabled:opacity-50"
            >
