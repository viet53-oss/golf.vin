    ...
    return (
        <div className="bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
            ...
            <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-green-600 text-white rounded-full text-[14pt] font-bold hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
            >
