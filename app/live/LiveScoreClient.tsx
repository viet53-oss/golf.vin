            ...
            <main className="w-full px-1 pt-1 m-0 space-y-1">
                ...
                {/* PLAYERS SECTION (Scoring) */}
                {
                    selectedPlayers.length > 0 && (
                        <div className="bg-white rounded-xl shadow-lg border-2 border-black my-1 py-0.5 px-2">
                            ...
                            <div className="space-y-0">
                                {[...selectedPlayers]
                                    ...
                                    .map(player => {
                                        ...
                                        return (
                                            <div key={player.id} className="flex justify-between items-center bg-gray-50 rounded-xl py-0.5 px-1">
